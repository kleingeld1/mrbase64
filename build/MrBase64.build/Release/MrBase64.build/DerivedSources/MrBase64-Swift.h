...
#ifndef MRBASE64_SWIFT_H
#define MRBASE64_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MrBase64",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSURL;
@class NSString;
SWIFT_CLASS("_TtC8MrBase6411AppDelegate")
